...
#pragma omp parallel for schedule(dynamic, 3)
        for (int stepic = 0; stepic < Max; stepic++) {
            ...
            /*
            matrix[0][0] = 1.2426986982423195;
            matrix[1][0] = 1.7263389564494176;
            matrix[2][0] = 1.660588944852646;
            matrix[3][0] = 1.6874937470585847;
            matrix[4][0] = 1.140938424972948;
            matrix[5][0] = 1.44643074424548596;
            matrix[6][0] = 1.717946826971669;
            matrix[7][0] = 2.0035334182645013;
            matrix[8][0] = 1.7037325346888046;
            matrix[9][0] = 1.42538761120465907;*/
